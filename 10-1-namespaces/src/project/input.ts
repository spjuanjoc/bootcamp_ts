...
namespace Input {
    export class ProjectInput {
        ...
        activeProjects: List.ProjectList;
        ...
        constructor() {
            ...
            this.activeProjects = new List.ProjectList('active');
        ...
        private gatherInput(): [string, string, number]/*returns 3 */ {
            ...
            if (!Utils.validate({value: title, required: true})) {
                alert('Title is required');
            } else if (!Utils.validate({value: description, required: true})) {
